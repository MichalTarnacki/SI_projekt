...
\begin{figure}[H]
	...
	\caption{}
\end{figure}
\noindent Po zaobserwowaniu w przybliżeniu liniowego charakteru tej relacji zastosowaliśmy metodę najmniejszych kwadratów do wyznaczenie najlepiej dopasowanej prostej. Otrzymaliśmy następujące wyniki:
\begin{gather*}
