...
\end{figure}
Dla każdego wyboru przeprowadziliśmy testy. W przypadku pierwszego uzyskaliśmy najlepsze wartości miar i dobre działanie w przypadku przewidywania na żywo. 
...
\begin{flalign*}
	&accuracy \approx 73\% &\\
	&precision_{wdech} \approx 68\% &\\
	&precision_{wydech} \approx 92\% &\\
	&recall_{wdech} \approx 86\% &\\
	&recall_{wydech} \approx 64\% &\\
	&F_{wdech} \approx 72\% &\\
	&F_{wydech} \approx 72\%. &
\end{flalign*}
...
\begin{flalign*}
	&accuracy \approx 83\% &\\
	&precision_{wdech} \approx 83\% &\\
	&precision_{wydech} \approx 83\% &\\
	&recall_{wdech} \approx 70\% &\\
	&recall_{wydech} \approx 91\% &\\
	&F_{wdech} \approx 76\% &\\
	&F_{wydech} \approx 86\%. &
\end{flalign*}
