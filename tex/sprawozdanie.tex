...
\begin{gather*}
	[\unit{Hz}]\approx43,0789\,[\unit{FU_{DFT}}]-2,8174,\\
	[\unit{FU_{DFT}}]\approx0,0232\,[\unit{Hz}]+0,068,
\end{gather*}
gdzie [\unit{FU_{DFT}}] to wartość liczbowa częstotliwości w jednostkach, w której otrzymuje się wynik DFT, natomiast [\unit{Hz}] to wartość liczbowa częstotliwości w \unit{Hz}.
...
\begin{figure}[H]
	...
	\caption{Spektrogramy dwóch nagrań oddechu z wdechem nosem i wydechem ustami uzyskane przy użyciu program Audacity.}
\end{figure}
