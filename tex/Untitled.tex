...
\section{Parametry zdrowotne}
\subsection{Respiratory rate}
\subsection{Procentowy udział wdechów i wydechów}
Podczas działania rozpoznawania na żywo zapisywane są poszczególne predykcje ich podstawie obliczany jest procentowy udział wdechów i wydechów w ciągu ostatniej minuty. Pozwala to w przybliżony sposób obliczyć stosunek średniej długości wdechów do wydechów.
